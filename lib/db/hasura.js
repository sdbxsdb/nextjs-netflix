...
//     insert_stats_one(object: {videoId: $videoId, watched: $watched, favourited: $favourited, userId: $userId}) {
//       favourited
//       id
//       userId
//       videoId
...
export async function updateStats(token, {favourited, userId, videoId, watched}) {
  const operationsDoc = `  
